  ...
  return (
    <div className="contenedor">
      ...
      <div className="my-5  container-fluid m-1 align-items-start g-2 row">
        <TableC dataVentas={dataVentas}  editar={editar} todasVentas={todasVentas}   setEditar={setEditar} setTodasVentas={setTodasVentas} setDataVentas ={setDataVentas}/>
        ...
        <NuevaVenta GetProductosDataAll={GetProductosDataAll} GetProductosData={GetProductosData} setProductosData={setProductosData} PostVentas={PostVentas} setTodasVentas={setTodasVentas} setDataVentas ={setDataVentas} GetVentas={GetVentas} setDataVentas={setDataVentas}></NuevaVenta>
      </div>
    </div>
  );
}
